            ...
            <form onSubmit={submit}>
              <div className="border pt-3 pb-3 bkg-darker shadow rounded mb-3">
                ...
                <div className="js-text px-3">
                  <p>
                    Create flashcards generated from your saved translations.
                    This will pull from any translations that you've saved
                    through the{" "}
                    <a href="/translate" className="about-bold">
                      Quick Translate
                    </a>{" "}
                    or{" "}
                    <a href="/translate" className="about-bold">
                    ...
                    features. Good luck with your studying!
                  </p>
                </div>
                <hr />
                <Button
          ...
          <Col xs="auto" lg={5}>
            <form onSubmit={submit}>
              <div className="border pt-3 pb-3 bkg-darker shadow rounded mb-3">
                ...
                <div className="js-text px-3">
                  <p>
                    Create flashcards generated from pre-existing sample
                    phrases. You can choose to create flashcards using easy,
                    medium, or hard phrases. This is an excellent option for
                    users who haven't saved any translations yet.
                  </p>
                </div>
                <hr />
                <Button
